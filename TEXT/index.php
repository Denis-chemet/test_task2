...
// Делим текст на массивы 
$array_word = preg_split("/[\s,:-]+/", strip_tags($text) );
// Удаляем пустые элементы и нерастежимые пробелы
$array_word = array_diff($array_word, array('',' '));

// Раделяем текст по разделителю которым является 30 слово
$new_text = explode($array_word[30], $text );
// Выводим
print_r($new_text[0].'...');
